...
| battlegrounds/strand | captured banners stay non-selectable after later gate destruction; both factions, round reset and relic eligibility | P2 | implemented, live validation pending (`TestAC_23129_*`); [exclusive-realm opt-in](suites/battlegrounds/strand/README.md) | #23129 |
