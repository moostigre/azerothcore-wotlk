...
| spells/aura | Permafrost slow returns after Freedom expires; another player stays slowed | P1 | covered (`TestAC_16496_*`); [scope and results](suites/spells/aura/permafrost.md) | #16496 |
